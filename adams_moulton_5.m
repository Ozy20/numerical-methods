function [t, y] = adams_moulton_5(f, a, b, h, y0)
    % Initialize arrays
    t = a:h:b;
    n = length(t);
    y = zeros(1, n);
    ...
    for i = 4:n-1
        y(i+1) = y(i) + h/720 * (251 * feval(f, t(i+1), y(i+1)) + 646 * feval(f, t(i), y(i)) - 264 * feval(f, t(i-1), y(i-1)) + 106 * feval(f, t(i-2), y(i-2)) - 19 * feval(f, t(i-3), y(i-3)));
    end
end
